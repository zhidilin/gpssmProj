...
from models.EnVI_TGP import EnVI_TGP as EnVI
...
for _, data_name in enumerate(data_name_all):
    ...
    DIR = f'results/SysID/EnVI_TGP_{data_name}/fixEmission_{fixEmission}_fixTrans_{fixTransition}_eNoise_{round(observation_noise_sd, 3)}_tNoise_{round(process_noise_sd, 3)}_consistentELBO_{sampleU}/'
